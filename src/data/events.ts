...
export const CRYPTO_EVENTS: CryptoEvent[] = [
  ...
  },
  {
    ...
    organizer: 'Chain Events Group',
    eventType: 'Expo',
    startDate: '2026-04-07',
    endDate: '2026-04-09',
    startTime: '08:30 CEST',
    endTime: '18:00 CEST',
    timeZone: 'Europe/Paris (CEST UTC+2)',
    ...
    description: 'Flagship European enterprise conference convening over 10,000 corporate decision makers, luxury brand tokenization teams, and regulatory compliance leaders under the Louvre Museum.',
    keySpeakers: ['Marie-Anne Barbat-Layani (AMF President)', 'Silvia Attanasio (ABI)', 'Nicolas Cary (Blockchain.com)'],
    topics: ['MiCA Enforcement', 'Luxury Brand RWA', 'Institutional Custody', 'CBDC Trials'],
    featured: true,
    ticketPrice: '€550 - €2,100'
  },
  {
    id: 'crypto-asia-expo-tokyo-2026',
    title: 'Crypto Asia Expo Tokyo 2026',
    slug: 'crypto-asia-expo-tokyo-2026',
    organizer: 'Japan Crypto Association',
    eventType: 'Expo',
    ...
    location: 'Tokyo Big Sight International Exhibition Center',
    city: 'Tokyo',
    country: 'Japan',
    isVirtual: false,
    website: 'https://cryptoasiaexpo.jp',
    description: 'East Asia’s foundational Web3 expo showcasing Japanese Web3 gaming studios, FSA-compliant stablecoin frameworks, and corporate blockchain integrations.',
    keySpeakers: ['Yuzo Kano (bitFlyer)', 'Kenji Kasahara (Mixi Web3)', 'Takashi Sano (FSA Policy)'],
    topics: ['Web3 Gaming', 'Yen Stablecoins', 'FSA Regulation', 'NFT Intellectual Property'],
    featured: false,
    ticketPrice: '¥15,000 - ¥60,000'
  },
  {
    id: 'bitcoin-2026-nashville',
    title: 'Bitcoin 2026 Conference',
    slug: 'bitcoin-2026-nashville',
    organizer: 'BTC Inc',
    eventType: 'Conference',
    ...
    description: 'The world’s largest Bitcoin-only gathering bringing together sovereign mining operations, Lightning Network architects, ETF issuers, and Bitcoin treasury corporations.',
    keySpeakers: ['Michael Saylor (MicroStrategy)', 'Jack Dorsey (Block)', 'Cathie Wood (ARK)'],
    topics: ['Bitcoin ETFs', 'Lightning Scalability', 'ASIC Efficiency', 'Sovereign Mining'],
    featured: false,
    ticketPrice: '$349 - $1,999'
  },
  {
  ...
  {
    id: 'hong-kong-web3-festival-2026',
    title: 'Hong Kong Web3 Festival 2026',
    slug: 'hong-kong-web3-festival-2026',
    organizer: 'Wanxiang Blockchain & HashKey Group',
    eventType: 'Summit',
    ...
    description: 'Hong Kong’s official Web3 summit co-hosted by HK government bodies, highlighting licensed crypto exchange licensing (SFC), tokenized real-world assets, and Asian liquidity hubs.',
    keySpeakers: ['Paul Chan (Financial Secretary HK)', 'Xiao Feng (HashKey Group)', 'Livio Weng (HashKey Exchange)'],
    topics: ['SFC Crypto Licenses', 'RWA Tokenization', 'Cross-Border Settlements', 'Stablecoin Sandbox'],
    featured: false,
    ticketPrice: '$300 - $1,100'
  }
];
